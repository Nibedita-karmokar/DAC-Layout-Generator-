...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  7 22:51:44 2022
...
class cap(object):
    ...
    cap_per_length_tb= 8.00e-02
    cap_per_length_bottom=1.25e-02     #M1 metal
    cap_per_length_coupling_32=7.00e-02     #M1 metal  32nm disttance
    cap_per_length_coupling_64=5.00e-02     #M1 metal  64nm disttance
    cap_per_length_coupling_96=4.00e-02     #M1 metal  96nm disttance
    cap_per_length_coupling_128=3.00e-02    #M1 metal  128nm disttance      
    cap_per_length_coupling_160=3.00e-02   #M1 metal  160nm disttance     
    cap_per_length_coupling_192=2.00e-02   #M1 metal  192nm disttance 
...
class capGenerator(object):
    ...
    def __init__(self, pdk):
        self.pdk=pdk
        self.pdk_abstraction()
        
    def pdk_abstraction(self):
    
        with open(self.pdk, "rt") as fp:
            j = json.load(fp)
            for i in range (len(j['Abstraction'])):
                if j['Abstraction'][i]['Layer']=='M1': 
                    capGenerator.Layers_dict['M1']=self.Metal_layer_information(j['Abstraction'][i])
                if j['Abstraction'][i]['Layer']=='V1': 
                    capGenerator.Layers_dict['V1']=self.Via_layer_information(j['Abstraction'][i])
                if j['Abstraction'][i]['Layer']=='M2': 
                    capGenerator.Layers_dict['M2']=self.Metal_layer_information(j['Abstraction'][i])
                if j['Abstraction'][i]['Layer']=='V2': 
                    capGenerator.Layers_dict['V2']=self.Via_layer_information(j['Abstraction'][i])
                if j['Abstraction'][i]['Layer']=='M3': 
                    capGenerator.Layers_dict['M3']=self.Metal_layer_information(j['Abstraction'][i])         
        
    def Metal_layer_information(self, k):
        M1={}
    ...
    def Via_layer_information(self,k):
        V1={}
        V1['WidthX']=k['WidthX']
        V1['WidthY']=k['WidthY']
    ...
    def pair_matrix(self, row, column, last_odd, odd_count):
        n=math.ceil((row*column)/2)
        
        pair_mat=np.zeros((n,2))

        capGenerator.new_list=copy.deepcopy(capGenerator.list1)
        
        #Pair matrix formation
        
        if row%2!=0 and column%2!=0 and odd_count!=0 and odd_count%2!=0:
            capGenerator.list1[0]=capGenerator.list1[0]-1
        ...
        if row%2!=0 and column%2!=0:
            bridge_first=1
        if capGenerator.circuit_type=='Split' and bridge_first==0: 
            pair_mat[len_p][0]=cap.bridge+1 
            pair_mat[len_p][1]=cap.bridge+1 
            len_p=len_p+1    
            
        loop_count_p=0
        for i in range (len(capGenerator.list1)):
            if capGenerator.list1[i]%2!=0:        
                pair_mat[len_p][p_k]=i+1
                capGenerator.list1[i]=capGenerator.list1[i]-1
                p_k=p_k+1
        ...
        for i in range (len(capGenerator.list1)):
            for j in range (capGenerator.list1[i]):
                if capGenerator.circuit_type=='Split' and bridge_first==0:
                    if capGenerator.list1[i]!=0 and i!=cap.bridge:
                        pair_mat[len_p][0]=i+1
                        pair_mat[len_p][1]=i+1
                        capGenerator.list1[i]=capGenerator.list1[i]-2
                        len_p=len_p+1
                else:
                    if capGenerator.list1[i]!=0:
                        pair_mat[len_p][0]=i+1
                        pair_mat[len_p][1]=i+1
                        capGenerator.list1[i]=capGenerator.list1[i]-2
                        len_p=len_p+1         
    ...
    def Placement_matrix(self, pair_mat, row, column, odd_count, Device_Name, len_list, Placement_type):
        mat = np.zeros((row,column))
        new_len=len_list+1
        if Placement_type=='Spiral':
            ...
            if row%2!=0 and odd_count!=0 and odd_count%2!=0:
                flag_mat=1
            elif row%2!=0 and column%2!=0 and odd_count!=0 and odd_count%2==0:
                flag_mat=1
            ...
            for k in range (size):
                ...
                for j in range (j_range):
                    for i in range (s):
                        ...
                        elif enter_condition==0:
                            
                            enter_condition=0
                            if mat[y][x]==0 and mat[row-y-1][column-x-1]==0 and n_k<len(pair_mat): 
                                
                                    
                                mat[y][x]=pair_mat[n_k][0]
                                mat[row-y-1][column-x-1]=pair_mat[n_k][1]
                                
                                if pair_mat[n_k][0]==0 and pair_mat[n_k][1]==0 and flag_row_column==0:
                                    last_row=y
                                    last_column=x
                                    flag_row_column=1
                                    #print('what is last row and column,',last_row, last_column, n_k, len(pair_mat) )
                                n_k=n_k+1
            ...
            if row!=column:
                if row>column:
                    ...
                    for j in range ((row-column)//2+1):
                        if y<row and row-y-1<row:
                        
                            if j%2==0:
                                
                                for i in range (column):
                                    if mat[y][i]==0 and mat[row-y-1][column-i-1]==0 and n_k<len(pair_mat):                
                                        mat[y][i]=pair_mat[n_k][0]
                                        mat[row-y-1][column-i-1]=pair_mat[n_k][1]
                                        if pair_mat[n_k][0]==0 and pair_mat[n_k][1]==0 and flag_row_column==0:
                                            last_row=y
                                            last_column=i
                                            flag_row_column=1
                    ...
                    for j in range ((column-row)//2+1):
                        if y<column and column-x-1<column:
                            if j%2==0:
                                for i in range (row):
                                    if mat[i][x]==0 and mat[row-i-1][column-x-1]==0 and n_k<len(pair_mat):                         
                                        mat[i][x]=pair_mat[n_k][0]
                                        mat[row-i-1][column-x-1]=pair_mat[n_k][1]
                                        if pair_mat[n_k][0]==0 and pair_mat[n_k][1]==0 and flag_row_column==0:
                                            last_row=i
                                            last_column=x 
                                            flag_row_column=1
        ...
        if Placement_type=='Chessboard':
            
            j_start=0
            print('capGenerator.list1',capGenerator.list1)
            n_k=capGenerator.new_list[len(capGenerator.new_list)-1]-1
    
            count=0
            while n_k>0:
    
                for i in range (row):
                    for j in range (j_start, column, 2):
                        if mat[i][j]==0 and mat[row-i-1][column-j-1]==0 and n_k>=0 : 
                            mat[i][j]=pair_mat[n_k][0]
                            mat[row-i-1][column-j-1]=pair_mat[n_k][1]
                            n_k=n_k-1 
    ...
    def cap_gen(self, unitCap_json, list1, circuit_type, Placement_type):
        capGenerator.list1=list1
        capGenerator.circuit_type=circuit_type

        with open(unitCap_json, "rt") as fp:
            cap_json = json.load(fp)        

         
        cap.w=cap_json['bbox'][2]
        cap.h=cap_json['bbox'][3]       
        ...
        for i in range (len(capGenerator.list1)):
            if capGenerator.list1[i]%2==0:        
                if i!=0 and capGenerator.list1[i]==2*capGenerator.list1[i-1]:                        
                    count_bit=count_bit+1
        
        if count_bit==len(capGenerator.list1)-2 and capGenerator.list1[0]%2!=0 and capGenerator.list1[1]%2!=0:
            capGenerator.circuit_type='Binary'
            
        if count_bit==len(capGenerator.list1)-2 and capGenerator.list1[0]%2==0 and capGenerator.list1[1]%2==0:
            capGenerator.circuit_type='Binary'  
                
        count_split=0    
        if capGenerator.list1[0]==capGenerator.list1[1]==capGenerator.list1[2]==1 and capGenerator.list1[3]==capGenerator.list1[4]==capGenerator.list1[5]==2:
            for i in range (6, len(capGenerator.list1)-1, 2):
                if capGenerator.list1[i]%2==0 and capGenerator.list1[i+1]%2==0 and capGenerator.list1[i]==capGenerator.list1[i+1] : 
                    count_split=count_split+1
                    
        if count_split==len(capGenerator.list1)-6-(len(capGenerator.list1)-6)//2 and count_split!=0:
            capGenerator.circuit_type='Split'
        ...
        len_list=len(capGenerator.list1)
        ...
        LSB_length=0
        MSB_length=0
        if capGenerator.circuit_type=='Binary':
            if len_list==7:
        ...
        elif capGenerator.circuit_type=='Split':
            if len_list==8:
                cap.time_constant=5.55
                LSB_length=4
                MSB_length=3        
        ...
        aspect_ratio=1
        a=sum(capGenerator.list1)
        r = math.ceil(sqrt(a*aspect_ratio))      #row size calculation
        c=math.ceil(a/r)            #column size calculation
                
        
        a=int(r/2)
        
        row=copy.deepcopy(r)
        column=copy.deepcopy(c)
        # row=8
        # column=4
        new_list=copy.deepcopy(capGenerator.list1)
        
        len_device_name=len(capGenerator.list1)
        
        if row*column>sum(capGenerator.list1):
            len_device_name=len(capGenerator.list1)+1
            new_list.append(len_device_name)
            
        
        Device_Name=[]
        
        for i in range (len_device_name):
        ...
        pair_mat=self.pair_matrix(row, column, last_odd, odd_count)
        (mat, new_len)=self.Placement_matrix(pair_mat, row, column, odd_count, Device_Name, len_list, Placement_type)
        ...
        already_listed_LSB=[]
        already_listed_MSB=[]
        if capGenerator.circuit_type =='Split':
                ...
                if len(obj[i][j].inter_connect)!=0  and obj[i][j].global_route_mark==0:
                    ...
                    if len(obj[i][j].inter_connect)!=new_list[i]:                  
                        if obj[i][j].common_track_marked_global!=0  and obj[i][j].global_route_mark==0 :
                            ind_j=0
                            possible_connection=[]
                            x_mirror=column-obj[i][j].x_coordinate-1
                            ...
                            if obj[i][j_index].global_route_mark!=0:
                                ...
                                x_mirror_1=column-obj[i][j_index_mirror].x_coordinate-1
                                ...
                                x_mirror_2=column-obj[i][k_index_mirror].x_coordinate-1
                            ...
                            if  len(possible_connection)!=0 and flag_done==0: 
                                ...
                                x_mirror=column-obj[i][ind_j_r].x_coordinate-1
                                ...
                                if capGenerator.circuit_type=='General':
        ...
        for i in range (len(obj)):
            for j in range (len(obj[i])):
                if len(obj[i][j].inter_connect)==new_list[i] and obj[i][j].common_track_marked_global==0 and len(obj[i][j].inter_connect)==1 and obj[i][j].global_route_mark==0:                
                    ...
                    flag_track=Global_detailed_routing_main.Track_number_in_channel(obj, row, column, global_track, obj[i][j].x_coordinate, obj[i][j].y_coordinate, a4, 0)
                    ...
                    flag_track=Global_detailed_routing_main.Track_number_in_channel(obj, row, column, global_track, obj[i][j_index].x_coordinate, obj[i][j_index].y_coordinate, a4, 0)
                ...
                for j in range (len(obj[i])):
                    if same_x_values[k][0]==i and same_x_values[k][1]==j and obj[i][j].global_route_mark==0: 
                        ...
                        if obj[i_index][j_index].global_route_mark!=0 and i==i_index:
                            ...
                            flag_track=Global_detailed_routing_main.Track_number_in_channel(obj, row, column, global_track, obj[i][ind_j_r].x_coordinate, obj[i][ind_j_r].y_coordinate, a4,  1)
                            global_track=Global_detailed_routing_main.Global_route_track_selection_same_x_unequal(flag_track, obj, i,j, ind_j_r, global_track, obj_channel) 
                            if flag_track==0:
                                obj[i][ind_j_r].top_sign=1
                            else:
        ...
        for i in range (len(obj)):
            ...
            for j in range (len(obj[i])):
                if obj[i][j].global_route_mark==0 and len(obj[i][j].inter_connect)!=0 and i+1 in All_conn:
                    ...
                    if seq%2==0:
                        for rr_1 in range (len(obj[i])):
                            (flag_track_2, Track_num_2)=Global_detailed_routing_main.Track_number_in_channel_2(obj, row, column, global_track, i, rr_1, a4)
                        ...
                        if flag_track==0:
                            ...
                            flag_track=0
                        Track_num=Track_num 
                        x_mirror=column-x_coordinate_all-1
                    ...
                    if Track_num==0:
                        ...
                        x_value_h=column-obj[i][j_index].x_coordinate-1
        ...
        cap.spacing=capGenerator.Layers_dict['M1']['Space']
        cap.wire_width=capGenerator.Layers_dict['M1']['Width']
        
        cap.sx=(cap.num+1)*capGenerator.Layers_dict['M1']['Space'] +(cap.num+1)*capGenerator.Layers_dict['M1']['Width']
        cap.sy=(cap.num_h+1)*capGenerator.Layers_dict['M2']['Space']+(cap.num_h+1)*capGenerator.Layers_dict['M2']['Width']
        ...
        if space_requirement=="Equal" : 
            ...
            for i in range (len(obj)): 
                for j in range (len(obj[i])):             
                    ...
                    obj[i][j].x_coordinate_new=round(((obj[i][j].x_coordinate+1)-(column+1)/2)*(cap.w+cap.sx),5)
                            ...
                            if d==1 :
                                if obj[i][k].ratio_marked==0:
                                    ...
                                    if stack_n[p][0]==obj[i][k].x_coordinate  :
                                        ...
                                        x_r_n=obj[i][new_k].x_coordinate_new+(cap.w/2)+1*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])
                                        x_l_n=obj[i][new_k].x_coordinate_new-(cap.w/2)-1*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])     
        
                                        x_r_t=obj[i][new_k].x_coordinate_new+(cap.w/2)+1*(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'])
                                        x_l_t=obj[i][new_k].x_coordinate_new-(cap.w/2)-1*(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'])     
        
            
                                        htrack=obj[i][new_k].y_coordinate_new-((cap.h)/2)+cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2
                                        htrack_1=obj[i][k].y_coordinate_new-((cap.h)/2)+cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2
                                        
                                        htrack_t=obj[i][new_k].y_coordinate_new+((cap.h)/2)-cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                                        htrack_t_1=obj[i][k].y_coordinate_new+((cap.h)/2)-cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2                                
            ...
            for i in range (len(obj)):
                ...
                for j in range (len(obj[i])):
                    ...
                    for c_p in range (1, cap.num+1):
                        x_r_n=obj[i][j].x_coordinate_new+(cap.w/2)+c_p*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])
                        x_l_n=obj[i][j].x_coordinate_new-(cap.w/2)-c_p*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width']) 
                        ...
                        x_r_t=obj[i][j].x_coordinate_new+(cap.w/2)+c_p*(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'])
                        x_l_t=obj[i][j].x_coordinate_new-(cap.w/2)-c_p*(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width']) 
        ...
        if space_requirement=="Unequal":
            ...
            for i in range (len(obj)): 
                for j in range (len(obj[i])):             
                    ...
                    obj[i][j].new_x=round(((obj[i][j].x_coordinate+1)-(column+1)/2)*(cap.w+cap.sx),5)
            ...
            if column%2==0:
                ...
                sx_mid=(len(total_track_count[len_t-1]))*(capGenerator.Layers_dict['M1']['Space'] +capGenerator.Layers_dict['M1']['Width'])
                
                x_start=((column/2+1)-((column+1)/2))*(cap.w+sx_mid) 
                x_start_z=((column/2)-((column+1)/2))*(cap.w+sx_mid)
            ...
            for i in range (len(x_uni_1)//2, len(new_chnl_t)-1):
                x_val = x_val   + (capGenerator.Layers_dict['M1']['Space'] +capGenerator.Layers_dict['M1']['Width'])*(len(new_chnl_t[i])+1)+cap.w
                
                actual_value = actual_value   + cap.sx +cap.w
                
                #print('x_values here', (capGenerator.Layers_dict['M1']['Space'] +capGenerator.Layers_dict['M1']['Width'])*(len(new_chnl_t[i])+2), cap.sx, len(new_chnl_t[i])+1)
                ...
                for j in range (len(obj[i])):
                    for k in range (len(new_x_list)):
                        ...
                        if round(obj[i][j].new_x,5)==round(new_x_list[k][1],5):
                            ...
                            diff=(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])*new_x_list[k][2]
                            ...
                            if d==1 :
                                if obj[i][k].ratio_marked==0:
                                    ...
                                    if stack_n[p][0]==obj[i][k].x_coordinate  :
                                        #d_1=cap.sy 
                                        d_1=abs(stack[p][1]-obj[i][k].y_coordinate_new)+cap.spacing
                                    #if c_p==1: obj[i][j].x_coordinate_new-(cap.w/2)-c_p*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width']) 
                                        x_r_n=obj[i][new_k].x_coordinate_new+(cap.w/2)+1*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])
                                        x_l_n=obj[i][new_k].x_coordinate_new-(cap.w/2)-1*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])     
                                        ...
                                        if obj[i][k].x_coordinate_new<=0:
                                            ...
                                            sx_channel=(track_number+1)*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])
                                            ...
                                            sx_channel_1=(track_number_1+1)*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])                                
                                            ...
                                            track_number=obj[i][new_k].channel_width_l
                                            sx_channel=(track_number+1)*(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'])
                                            ...
                                            track_number_1=obj[i][k].channel_width_l
                                            sx_channel_1=(track_number_1+1)*(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'])                                
        ...
        # removed_top_wire=Layout_generator.Generalized_plot_top_bottom_NON_DAC(obj, new_list, Device_Name, mat, row, column, cap.w, cap.sx, cap.h, cap.sy, my_color, cap.line_w_2, color_mat, cap.metal_layer_number, cap.wire_width, cap.spacing, Terminal_list, capGenerator.Layers_dict, cap)
        removed_top_wire=Layout_generator.Generalized_plot_top_bottom_3(obj, new_list, Device_Name, mat, row, column, cap.w, cap.sx, cap.h, cap.sy, my_color, cap.line_w_2, color_mat, cap.metal_layer_number, cap.wire_width, cap.spacing, Terminal_list, capGenerator.Layers_dict, cap)
        ...
        wire_length_MSB=0
        if capGenerator.circuit_type=='Binary': 
            (length_top_1, total_bottom_length)=Layout_generator.Top_plate_routing_plot(obj,  mat, row, column, cap.w, cap.sx, cap.h, cap.sy, my_color, cap.line_w, a4,  cap.spacing, cap.wire_width, Terminal_list, capGenerator.Layers_dict, cap)
        elif capGenerator.circuit_type=='Split': 
            (wire_length_LSB, wire_length_MSB)=Layout_generator.Top_plate_routing_plot_Split_DAC(obj,  mat, row, column, cap.w, cap.sx, cap.h, cap.sy, my_color, cap.line_w, a4,  cap.spacing, cap.wire_width, Terminal_list, capGenerator.Layers_dict, cap, detailed_tr_top, horizontal, horizontal_track_new_top, maximum_y)
        ...
        if capGenerator.circuit_type=='Split':
            ...
            if obj[cap.bridge][0].y_coordinate!=row-1:
                ...
                if i_index_4%2==0 and flag_1==0 and i_index_4!=cap.bridge:            
                    ...
                    plt.gca().add_patch(patches.Rectangle((x-capGenerator.Layers_dict['M3']['Width']/2, y-capGenerator.Layers_dict['V2']['VencA_H']-capGenerator.Layers_dict['V2']['WidthY']/2),  capGenerator.Layers_dict['M3']['Width'], abs(y1-y2)+2*capGenerator.Layers_dict['V2']['VencA_H']+capGenerator.Layers_dict['V2']['WidthY'],color='k'))                                                                        
                    wire_segment_1=Layout_generator.wire('M3', None, capGenerator.Layers_dict['M3']['Direction'])
                    Terminal_list.append(wire_segment_1.segment(x-capGenerator.Layers_dict['M3']['Width']/2, y-capGenerator.Layers_dict['V2']['VencA_H']-capGenerator.Layers_dict['V2']['WidthY']/2, x+capGenerator.Layers_dict['M3']['Width']/2, y+abs(y1-y2)+capGenerator.Layers_dict['V2']['VencA_H']+capGenerator.Layers_dict['V2']['WidthY']/2, 'drawing', capGenerator.Layers_dict['M3']['Color'][0]))
            ...
            if obj[cap.bridge][0].y_coordinate!=0 :
                ...
                if i_index_3%2==0 and flag_1==0 and i_index_3!=cap.bridge:            
                    ...
                    y1=obj[cap.bridge][0].y_coordinate_new-cap.h/2 + cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2
                    y2=obj[i_index_3][j_index_3].y_coordinate_new+cap.h/2 - cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                    y=y1 
                    flag_1=1
                    ...
                    if  obj[cap.bridge][0].x_coordinate_new<=0:           
                        x=obj[cap.bridge][0].x_coordinate_new-cap.w/2-capGenerator.Layers_dict['M3']['Space']-capGenerator.Layers_dict['M3']['Width']
                        Layout_generator.top_plate_vertical(x, y, y1, y2, capGenerator.Layers_dict, Terminal_list, cap)
            
                        Layout_generator.left_array_top_plate_horizontal(x, y1, capGenerator.Layers_dict, Terminal_list, cap)
                        Layout_generator.top_plate_via(x, y1, cap.h, capGenerator.Layers_dict, Terminal_list, cap)
                        
                        Layout_generator.left_array_top_plate_horizontal(x, y2, capGenerator.Layers_dict, Terminal_list, cap)
                        Layout_generator.top_plate_via(x, y2, cap.h, capGenerator.Layers_dict, Terminal_list, cap)
                    elif  obj[cap.bridge][0].x_coordinate_new>0: 
                        x=obj[cap.bridge][0].x_coordinate_new+cap.w/2+capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width']
                        Layout_generator.top_plate_vertical(x, y, y1, y2, capGenerator.Layers_dict, Terminal_list, cap)
         
                        Layout_generator.right_array_top_plate_horizontal(x, y1, capGenerator.Layers_dict, Terminal_list, cap)
                        Layout_generator.top_plate_via(x, y1, cap.h, capGenerator.Layers_dict, Terminal_list, cap) 
                                    
                        Layout_generator.right_array_top_plate_horizontal(x, y2, capGenerator.Layers_dict, Terminal_list, cap)
                        Layout_generator.top_plate_via(x, y2, cap.h, capGenerator.Layers_dict, Terminal_list, cap)                 
            ...
            if  obj[cap.bridge][1].y_coordinate!=0:
                ...
                if i_index_3%2==0 and flag_1==0 and i_index_3!=cap.bridge:             
                    ...
                    y1=obj[cap.bridge][1].y_coordinate_new-cap.h/2 + cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2
                    y2=obj[i_index_3][j_index_3].y_coordinate_new+cap.h/2 - cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                    y=y1 
                    flag_1=1
                    obj[cap.bridge][0].via_number_top=obj[cap.bridge][0].via_number_top+1
                    ...
                    if  obj[cap.bridge][1].x_coordinate_new<=0:           
                        x=obj[cap.bridge][1].x_coordinate_new-cap.w/2-capGenerator.Layers_dict['M3']['Space']-capGenerator.Layers_dict['M3']['Width']
                        Layout_generator.top_plate_vertical(x, y, y1, y2, capGenerator.Layers_dict, Terminal_list, cap)
            ...
            for j in range (len(obj[i])):
                ...
                if len(obj[i][j].inter_connected)!=0 and obj[i][j].detailed_route_mark==0  and i+1 not in cap.ring_name_cap :
                    if obj[i][j].common_track_marked_global==0: 
                        ...
                        x_mirror=column-obj[i][obj[i][j].lowest_y_j].x_coordinate-1
                        ...
                        htrack=y_value_j-((cap.h)/2)+cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2
                        ...
                        htrack_l=(minimum_y-((cap.h)/2)-capGenerator.Layers_dict['M2']['Width']/2-capGenerator.Layers_dict['M2']['Space'])
                        ...
                        Layout_generator.Horizontal_track_plot(track_one, htrack, cap.w, cap.h, x_value_j, y_value_j, cap.line_w, color_r, new_f, capGenerator.Layers_dict, Terminal_list, cap)
                        ...
                        if capGenerator.circuit_type=='General':
                            ...
                            htrack_top=y_top+((cap.h)/2)-cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                            
                            sx_channel_top=(track_number+1)*(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'])
                            ...
                            Layout_generator.Horizontal_track_plot_top(track_two, htrack_top, cap.w, cap.h, x_top, y_top, cap.line_w, color_r, new_f_top, capGenerator.Layers_dict, Terminal_list, cap)
                        ...
                        if obj[i][j_new].identity in obj[i][j].inter_connected: 
                            ...
                            if len(obj[i][j_new].connected_pins)!=0:
                                ...
                                if capGenerator.circuit_type=='General':
                                    ...
                                    htrack_top=y_value_max+((cap.h)/2) -cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                                    ...
                                    Layout_generator.Horizontal_track_plot_top(track_top, htrack_top, cap.w, cap.h, x_value_j, y_value_max, cap.line_w, color_r, new_f_top, capGenerator.Layers_dict, Terminal_list, cap)
                                ...
                                for index_c in other_index:
                                    ...
                                    if obj[i][index_c].detailed_route_mark==0:                                                      
                                        ...
                                        htrack_index=y_min_cal_index_bottom-((cap.h)/2)+cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2
                                        ...
                                        Layout_generator.Horizontal_track_plot(track_one, htrack_index, cap.w, cap.h, x_value_index_c, y_min_cal_index_bottom, cap.line_w, color_r, new_f_index_c, capGenerator.Layers_dict, Terminal_list, cap)
                                        ...
                                        if capGenerator.circuit_type=='General':
                                            ...
                                            htrack_index_top=y_min_cal_index_top+((cap.h)/2)-cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                                            ...
                                            #Global_detailed_routing_main.Detailed_route_performed(obj, i, index_plot)                                
                                            Layout_generator.Horizontal_track_plot_top(track_top, htrack_index_top, cap.w, cap.h, x_value_index_top, y_min_cal_index_top, cap.line_w, color_r, new_f_index_c_top, capGenerator.Layers_dict, Terminal_list, cap)
        
                                        
                                        loop_c=loop_c+1
                                        Global_detailed_routing_main.track_assignment(obj, i, index_plot, track_one, track_top)  
                                                              
                                if capGenerator.circuit_type=='Split' and i==cap.bridge: 
                                    #print('are u crazy', i)
                                    var=str(int(i))
                                    Layout_generator.trunk_routing(track_one, htrack_bridge, htrack, capGenerator.Layers_dict, Terminal_list, cap, color_r, index, var)     
                                    Layout_generator.trunk_routing_via(track_one, htrack, capGenerator.Layers_dict, Terminal_list, cap)
                                    Layout_generator.trunk_routing_via(track_one, htrack_bridge, capGenerator.Layers_dict, Terminal_list, cap)
                                    #Layout_generator.top_plate_via(x, y, cap.h, capGenerator.Layers_dict, Terminal_list, cap)
                                    ...
                                    htrack_top=y_value_j+((cap.h)/2) -cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                                    ...
                                    htrack_index_top=y_min_cal_index_bottom+((cap.h)/2)-cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                                    ...
                                    Layout_generator.Horizontal_track_plot_top(track_top, htrack_top, cap.w, cap.h, x_value_j, y_value_j, cap.line_w, color_r, new_f, capGenerator.Layers_dict, Terminal_list, cap)
        
                                    Layout_generator.Horizontal_track_plot_top(track_top, htrack_index_top, cap.w, cap.h, obj[i][other_index[0]].x_coordinate_new, obj[i][other_index[0]].y_coordinate_new   , cap.line_w, color_r, new_f_index_c, capGenerator.Layers_dict, Terminal_list, cap)
        
                                    Layout_generator.trunk_routing_top(track_top, htrack_index_top, htrack_top, capGenerator.Layers_dict, Terminal_list, cap, 'r', var)     
                                    Layout_generator.top_plate_via(track_one, htrack_top, cap.h, capGenerator.Layers_dict, Terminal_list, cap)
                                    Layout_generator.top_plate_via(track_one, htrack_index_top, cap.h, capGenerator.Layers_dict, Terminal_list, cap)
        ...
        for i in range (len(obj)):
            ...
            for j in range (len(obj[i])):
                ...
                if len(obj[i][j].inter_connected)!=0 and obj[i][j].detailed_route_mark==0 and obj[i][j].cap_name not in All_conn :
                    ...
                    new_assign=[]
                    new_assign.append(round(track_one,5))
                    htrack=y_min_cal_j_r-((cap.h)/2)+cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2 
                    ...
                    if capGenerator.circuit_type=='General':
                        ...
                        Layout_generator.Horizontal_track_plot_top(track_top, htrack_top, cap.w, cap.h, x_top, y_value_max, cap.line_w, color_r, new_f_top, capGenerator.Layers_dict, Terminal_list, cap)
                    ...
                    Layout_generator.Horizontal_track_plot(track_one, htrack, cap.w, cap.h, x_value_j, y_min_cal_j_r, cap.line_w, color_r, new_f, capGenerator.Layers_dict, Terminal_list, cap)            
            ...
            for i in range (len(obj)):
                ...
                for j in range (len(obj[i])):
                    ...
                    if len(obj[i][j].inter_connected)==new_list[i]  and obj[i][j].detailed_route_mark==0 :        
                            ...
                            if len(same_channel)<=2:     
                                ...
                                for cnt in range (2, cap.num+1): 
                                    if counter_for_side%2==0:                                 
                                        v_t_right=min_x+cap.w/2+(cnt*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width']))
                                        x_val=min_x
                                        index=cnt
                                    else:
                                        v_t_right=-min_x-cap.w/2-(cnt*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width']))
                        ...
                        h_t=y_min_cal_j_r-cap.h/2+cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2
                        #htrack_l=minimum_y-cap.h/2-cap.sy
            
                        if len(obj[len_list-1][j].inter_connected)==new_list[len_list-1]:
                        ...
                        #Layout_generator.Horizontal_track_plot(v_next, h_t, cap.w, cap.h, x_value_j_min, y_min_cal_j_r, cap.line_w, color_r, flag,  capGenerator.Layers_dict, Terminal_list, cap)
                        Layout_generator.trunk_routing(v_next, htrack_l, h_t, capGenerator.Layers_dict, Terminal_list, cap, color_r, index, var) 
                        Layout_generator.trunk_routing_via(v_next, h_t, capGenerator.Layers_dict, Terminal_list, cap)
                        ...
                        if capGenerator.circuit_type=='General':
                            h_t_u=y_max_cal_j_r+cap.h/2-cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2
                            ...
                            Layout_generator.Horizontal_track_plot_top(-v_next, h_t_u, cap.w, cap.h, -x_value_j_min, y_max_cal_j_r, cap.line_w, color_r, flag,  capGenerator.Layers_dict, Terminal_list, cap)
        ...
        total_bottom_length=0    
        (bridge_first_last, Only_per_cap_ratio, last_h, Bridge_wires_1_new, Via_Num, total_bottom_length, new_connecting_wire)=Layout_generator.Bridge_connection(cap.wire_length, minimum_y, cap.h, cap.sy, cap.num_h, my_color, cap.a_t_h_ratio, Via_Num, Device_Name, cap.line_w, total_bottom_length, All_conn, Only_per_cap_ratio, capGenerator.Layers_dict, Terminal_list, cap, obj)
        if capGenerator.circuit_type=='General':
            (bridge_first_last_top, Only_per_cap_ratio_top, first_h, Bridge_wires_1_new_top, Via_Num, total_top_length, new_connecting_wire_top)=Layout_generator.Bridge_connection_top(cap.wire_length_top, maximum_y, cap.h, cap.sy, cap.num_h, my_color, cap.a_t_h_ratio, Via_Num, Device_Name, cap.line_w, total_bottom_length, All_conn, Only_per_cap_ratio, capGenerator.Layers_dict, Terminal_list, cap, obj)
        
         
        Bridge_wires_1_new.append(minimum_y-cap.h)
                
        
        max_x_terminal=max_x_coor+cap.w+4*(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'])
        max_y_terminal=max_y_coor+cap.h+4*(capGenerator.Layers_dict['M2']['Space']+capGenerator.Layers_dict['M2']['Width'])
        ...
        #bounding_box_y_max=2*(max_y_coor+cap.h/2+2*(capGenerator.Layers_dict['M2']['Space']+capGenerator.Layers_dict['M2']['Width']))*cap.scale_factor
        
        
        Layout_generator.CC_plot(obj, Device_Name, mat, row, column, cap.w, cap.sx, cap.h, cap.sy, my_color, cap.line_w, cap, Terminal_list)
        ...
        for i in range (len(obj)):
            for j in range (len(obj[i])):
                ...
                for term in cap_json['terminals']: 
                    unit_capacitor=Layout_generator.unit_cap(term['layer'], term['netName'])
        ...
        with open('Cap_layers_DAC.json', "w") as fp:
...
class horizontal(cap):
    ...
    def __init__(self, i, track_1, y_axis, x_axis, horizontal_track_new, sx, htrack):   
        ...
        self.htrack=round(self.y_axis - cap.h/2+cap.pin_y+capGenerator.Layers_dict['M2']['Width']/2,5)
        self.htrack_1=round(self.y_axis + cap.h/2-cap.pin_y-capGenerator.Layers_dict['M2']['Width']/2,5)
            ...
            if abs(self.track_1-self.horizontal_track_new[n_2][1])<cap.w+self.sx: 
                ...
                if abs(self.y_axis-self.horizontal_track_new[n_2][0])<cap.h+cap.sy and self.y_axis>self.horizontal_track_new[n_2][0] and round(self.y_axis,5)==round(self.horizontal_track_new[n_2][3],5):                       
                    if round(abs(round(self.x_axis,5)-self.horizontal_track_new[n_2][2]),5)==round(cap.w+self.sx,5) and round(self.x_axis,5)!=round(self.horizontal_track_new[n_2][2],5):                                                              
                        ...
                        if round(self.htrack,5)==round(self.horizontal_track_new[n_2][0],5) and round(abs(self.track_1-self.horizontal_track_new[n_2][1]),5)==round(capGenerator.Layers_dict['M1']['Space']+capGenerator.Layers_dict['M1']['Width'],5):
                            self.new_f_1=1
                            break
            ...
            if abs(self.track_1-self.horizontal_track_new[n_2][1])<cap.w+self.sx:
                ...
                if abs(self.y_axis-self.horizontal_track_new[n_2][0])<cap.h+cap.sy and self.y_axis<self.horizontal_track_new[n_2][0] and round(self.y_axis,5)==round(self.horizontal_track_new[n_2][3],5):  
                    if round(abs(round(self.x_axis,5)-self.horizontal_track_new[n_2][2]),5)==round(cap.w+self.sx,5) and round(self.x_axis,5)!=round(self.horizontal_track_new[n_2][2],5):                                                              
                        ...
                        if round(self.htrack_1,5)==round(self.horizontal_track_new[n_2][0],5) and round(abs(round(self.track_1,5)-round(self.horizontal_track_new[n_2][1],5)),5)==round(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'],5):
                            self.new_f_1=1                             
                            break
                        if round(self.x_axis,5)<round(self.horizontal_track_new[n_2][2],5) and self.track_1>round(self.horizontal_track_new[n_2][1],5):
                            self.new_f_1=1
            ...
            if abs(self.track_1-self.horizontal_track_new[n_2][1])<cap.w+self.sx:
                ...
                if abs(self.y_axis-self.horizontal_track_new[n_2][0])<cap.h+cap.sy and self.y_axis<self.horizontal_track_new[n_2][0] and round(self.y_axis,5)==round(self.horizontal_track_new[n_2][3],5):  
                    if round(abs(round(self.x_axis,5)-self.horizontal_track_new[n_2][2]),5)==round(cap.w+self.sx,5) and round(self.x_axis,5)!=round(self.horizontal_track_new[n_2][2],5):                                                              
                        ...
                        if round(self.htrack_1,5)==round(self.horizontal_track_new[n_2][0],5) and round(abs(round(self.track_1,5)-round(self.horizontal_track_new[n_2][1],5)),5)==round(capGenerator.Layers_dict['M3']['Space']+capGenerator.Layers_dict['M3']['Width'],5) and even_odd_flag==1:
                            self.new_f_1=1                                                
                            break
    ...
    def horizontal_track_assign(self):
        # self.htrack=self.y_axis - cap.h/2+capGenerator.Layers_dict['M2']['Width']/2+cap.pin_y-capGenerator.Layers_dict['M2']['Space']-capGenerator.Layers_dict['M2']['Width']
        self.htrack=self.y_axis - cap.h/2-capGenerator.Layers_dict['M2']['Space']-capGenerator.Layers_dict['M2']['Width']/2
        return self.htrack      
